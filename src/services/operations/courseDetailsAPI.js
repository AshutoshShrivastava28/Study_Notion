...
export const deleteCourse = async (data, token) => {
  ...
  try {
    // Log data and token
    console.log("DELETE COURSE API CALL DATA:", data);
    console.log("DELETE COURSE API CALL TOKEN:", token);
...
export const createRating = async (data, token) => {
  ...
  let success = false;
  try {
    // Highlighted: Ensure the method, endpoint, and headers are correct
